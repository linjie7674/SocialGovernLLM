...
llm_model_dict = {
    # "chatglm-6b": {
    #     "local_model_path": "~/code/others/Langchain-Chatchat/chatglm2-6b",
    #     "api_base_url": "http://localhost:8888/v1",  # "name"修改为fastchat服务中的"api_base_url"
    #     "api_key": "EMPTY"
    # },
    "chatglm2-6b": {
        "local_model_path": f"{root_dir}/chatglm2-6b",
    ...
    "vicuna-13b-v1.5": {
        "local_model_path": f"{root_dir}/models/base-models/vicuna-13b-v1.5",
        "api_base_url": "http://localhost:8888/v1",  # "URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },

    "vicuna-7b-v1.5": {
        "local_model_path": f"{root_dir}/models/base-models/vicuna-7b-v1.5",
        "api_base_url": "http://localhost:8888/v1",  # "URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },

    "baichuan-13b-chat": {
        "local_model_path": f"{root_dir}/models/base-models/Baichuan-13B-Chat",
        "api_base_url": "http://localhost:8888/v1",  # "URL需要与运行fastchat服务端的server_config.FSCHAT_OPENAI_API一致
        "api_key": "EMPTY"
    },
